...
<head>
    ...
    <meta property="og:url"    content="http://www.4ces.org" />
    <meta property="og:image"  content="http://4ces.org/images/compartir.jpg" />
    <meta property="og:description" content="Suscríbete al boletín informativo del 4º Congreso Espírita Suramericano y estarás al tanto de toda las noticias del evento." />
    <meta property="og:title"  content="4º Congreso Espírita Suramericano, Bgotá 14, 15 y 16 Octubre 2017" />
    <meta name="author" content="Camilo Diaz www.camilodiaz.in">
    <meta name="owner" content="Confederación Espírita Colombiana CONFECOL">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                            ...
                                            <span class="pull-left">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span> Octubre 14, 15 y 16, 2017</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                            ...
                                            <span class="pull-left">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="media-heading">Bogotá - Colombia Av 68 N° 49A - 47 </h4>
                                                    <span> Centro de Convenciones Compensar </span>
                                                </div>
                                            </div>
                                        </div>
        ...
        <section class="page-section" id="about">
            <div class="container">
                <h1 class="section-title">
                    ...
                    <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">4° Congreso Espírita Suramericano <small> /Bogotá - Colombia 14, 15 y 16 octubre 2017. 4:00 p.m
</small></span>
                </h1>
                <div class="row">
                    <div class="col-lg-8">
                        <p data-animation="fadeInUp" data-animation-delay="300">
                            La programación doctrinaria del 4° Congreso Espírita Suramericano será el desarrollo del temario de El Libro de Los Espíritus de Allan Kardec, en conmemoración de los 160 años de su publicación en la ciudad de París, el 18 de abril de 1857. <br><br>

                            El 4º Congreso Espírita Suramericano, que será divulgativo, se caracterizará por el enfoque novedoso, ágil, práctico y vivencial que se dará a los temas de El Libro de Los Espíritus, los cuales estarán a cargo de oradores y expositores espíritas representativos del movimiento suramericano y nacional, de quienes se espera desde ya una masiva participación.<br><br>

                            El tema central del Congreso será “La Era del Espíritu Inmortal”, con el lema: “Doctrina Espírita, Camino a la Felicidad
                                                        </p>
                        <p class="btn-row">
                            <a href="http://confecol.org/payu/" class="btn btn-theme btn-theme-xl scroll-to" data-animation="flipInY" data-animation-delay="200" target="_blank">Comprar inscripción <i class="fa fa-arrow-circle-right"></i></a><!--
                            --><a href="#" class="btn btn-theme btn-theme-xl btn-theme-transparent" data-animation="flipInY" data-animation-delay="400">Instructivo pago </a>
                        </p>
                    </div>
        ...
        <section class="page-section image" id="register">
            <div class="container">
                <h1 class="section-title">
                    ...
                    <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">¡ NOTICIAS DE 4CES ! <small> / Recibe información en tu correo electrónico!</small></span>
                </h1>
                    <script type="text/javascript" src="https://app.getresponse.com/view_webform_v2.js?u=BB9K&webforms_id=9916201"></script>
            </div>
        </section>
        <!-- /Donation -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 pull-left">
                        <h1 class="section-title">
                            <span data-animation="flipInY" data-animation-delay="300" class="icon-inner"><span class="fa-stack"><i class="fa crcle fa-stack-2x"></i><i class="fa fa-star fa-stack-1x"></i></span></span>
                            <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">Programación 4CES <small>/ 48 Conferencistas </small></span>
                        </h1>
                    </div>
                ...
                <div class="schedule-wrapper clear" data-animation="fadeIn" data-animation-delay="200">
                    <div class="schedule-tabs lv1">
                        <ul id="tabs-lv1"  class="nav nav-justified">
                            ...
                            <li><a href="#tab-last" data-toggle="tab"><strong> Clausura </strong><br/> 16-10-2017 </a></li>
                        </ul>
                    </div>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 09:10 - 09:50 AM</span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                    ...
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Marcelo Netto.  / Estados Unidos
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap. IV, 60 a 67</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap.I, 76 a 83</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#">Ascenso Espiritual Hacia la Plenitud</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap.I, 96 a 131</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> José Vásquez. / Venezuela
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 11:40 AM - 12:20 AM</span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#">La Vivencia Espírita Frente al Materialismo Actual</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap.II, 147 y 148</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Jorge Camargo Zurita. / México
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#">Las Reencarnaciones sucesivas – Camino Hacia la Perfección</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap.IV, 166 a 170</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Anyela Núñez. / Uruguay
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#">El Sexo como Herramienta de Amor y Progreso</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap. IV, 200 a 202</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Pablo Arias. / Uruguay
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#">Elección de Pruebas como Mecanismo Evolutivo</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap.VI, 258 a 273</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Axel Rhenals. / Colombia
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#">Preludios del Retorno a la Vida Corporal</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap.VI, 258 a 273</p>
                                                    ...
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Jhonny Navarro. / Colombia
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#">La Infancia como Escuela del Alma</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Libros de los espíritus Cap.VII, 379 a 385</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> María de la Gracia de Ender. / Panamá
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#"> Utilidad de los estados de emancipación del Alma </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.VIII, 400 a 454. </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Jose Noguera. / Venezuela
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#"> La evolución anímica </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> EL libro de los Espíritus Cap. XI, 585 a 610.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Alejandro Sosa.  / Argentina
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 09:50 - 10:30 AM</span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> Adoración y oración: recursos del Espíritu para su conexión con Dios </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus  Cap.II, 649 a 666 </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Elsa Rossi. Inglaterra / Inglaterra
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 11:00 - 11:40 AM </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> Nacer en la Tierra: un derecho del Espíritu </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus  Cap.IV, 693 y 694 – Cap.VII, 358 a 360 (Libro II) – Cap.VI, 728 a736 y 742 a 765 – También Libro IV, 943 a 950. </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Claudia Werdine.  / España
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 12:20 - 1:00 PM </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> Ley de libertad: conquista del Espíritu inmortal </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus  Cap.X, 825 a 872. </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Carmen Cardona.  / Colombia.
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 3:00 - 6:00 PM </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> La Era del Espíritu Inmortal </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Clausura 4 Congreso Espirita Suramericano  y Conferencia Divaldo Pereira Franco </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i>  Divaldo Pereira Franco.
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#"> La acción benéfica del mundo de los Espíritus </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.IX, 456 a 524.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Mónica Oliveira.  / Ecuador
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#"> La ley natural como expresión del amor divino </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.I, 614 a 623.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Blanca Ines Orozco. / Colombia
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#"> El Trabajo como dádiva Divina </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.III, 674 a 685 a.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Eduardo dos Santos.  / Uruguay.
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#"> Visión Espírita de la Constelación Familiar </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap. IV, 695 a 701.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Eduardo Nanni.   / Brasil.
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 11:40 - 12:20 M </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> El progreso del hombre en tiempos de transición planetaria. </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.VIII, 776 a 802.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Javier Franco.   / Chile.
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 12:20 - 13:00 PM </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> La Ley de Justicia, Amor y Caridad. </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.XI, 873 a 892.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Francisco León. / Colombia.
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 8:30 - 9:10 AM </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> Influencia de los Espíritus en los acontecimientos de la vida </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.IX, 525 a 547  </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> John Doe / Paraguay
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 9:10 - 9:50 AM </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> El bien y el mal en la moral Espírita </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.I, 629 a 646 </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Jorge Godinho. / Brasil
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 9:50 - 10:30 AM </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                        ...
                                                        <h2 class="post-title"><a href="#"> Ley de reproducción y la problemática poblacional </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap. IV, 686 a 692 a.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Nabor Jaramillo.  / Colombia
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#"> Amor a la naturaleza en el enfoque Espírita </a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.V, 702 a 714  -  Cap.VI, 728 a 741 </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Hugo Arriciaga.   / Ecuador.
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 12:00 - 13:00 PM </span>
                                                            <a href="#" class="pull-right">
                                                                <span class="fa-stack fa-lg">
                                                                    <i class="fa fa-stack-2x fa-circle-thin"></i>
                                                                    <i class="fa fa-stack-1x fa-share-alt"></i>
                                                    ...
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Libro de los Espíritus Cap.XII, 893 a 919. </p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
                                                            <i class="fa fa-microphone"></i> Jose Angel Cueto.  / Colombia.
                                                            <a href="#"><i class="fa fa-facebook"></i></a>
                                                            <a href="#"><i class="fa fa-twitter"></i></a>
                                                            <a href="#"><i class="fa fa-linkedin"></i></a>
                                                            <a href="#"><i class="fa fa-instagram"></i></a>
                        ...
                        <div id="tab-last" class="tab-pane fade">
                            <div class="schedule-tabs lv2">
                                <ul id="tabs-lv24"  class="nav nav-justified">
                                    <li class="active"><a href="#tab-lv24-first" data-toggle="tab"> Gran Auditorio </a></li>
                                </ul>
                            </div>
                            <div class="tab-content lv2">
                                        ...
                                        <article class="post-wrap">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p> Conferencia de clausura a cargo de Divaldo Pereira Franco.</p>
                                                        </div>
                                                    </div>
                                                    <div class="post-footer">
                                                        <span class="post-readmore">
        ...
        <section class="page-section" id="price">
            <div class="container">
                <h1 class="section-title clearfix">
                    ...
                    <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner"> Precio Inscripción <small> / 4° Congreso Espírita Suramericano </small></span>
                </h1>
                <div class="row price-tables">
                    <div class="col-xsp-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="price-table" data-animation="fadeInUp" data-animation-delay="100">
                            <div class="price-table-header">
                                <div class="price-label">
                                    <h2 class="price-label-title"> Residentes en Colombia </h2>
                                </div>
                    ...
                    <div class="col-xsp-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="price-table" data-animation="fadeInUp" data-animation-delay="200">
                            <div class="price-table-header">
                                <div class="price-label">
                                    <h2 class="price-label-title"> Residentes Fuera de  Colombia </h2>
                                </div>
                                <div class="price-value">
                                    <span class="price-number">$120</span><span class="price-per"></span><span class="price-unit">USD</span><span class="price-per"></span>
                                </div>
                            </div>
                            <div class="price-table-rows">
                                <div class="price-table-row"><i class="fa fa-check-circle-o"></i> Inscripción 4° Congreso Espírita Suramericano, 14, 15 y 16 octubre 2017. </div>
        ...
        <section class="page-section light">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right-md pull-right">
                        <a href="http://confecol.org/payu/user/contacto.php" class="btn btn-theme btn-theme-lg btn-theme-transparent-grey pull-right"
                           data-animation="flipInY" data-animation-delay="700" target="_blank"><i class="fa fa-pencil"></i> Realizar una Pregunta </a>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="on-gmap color">
                        <h1 class="section-title">
                            ...
                            <span data-animation="fadeInRight" data-animation-delay="100" class="title-inner">Lugar del Evento </span>
                        </h1>
                        <p data-animation="fadeInUp" data-animation-delay="200" class="text-uppercase">Centro de Convenciones Compensar <br/>
                            BOGOTÁ - COLOMBIA , <br/>
                            AV 68 N° 49A - 47 <br/>
                            +57 316 37 22 114</p>
                        <p><a href="mailto:youremail@domain.com">info@4ces.org </a></p>
                        <a href="https://goo.gl/maps/kgC4hgAG6Eo"  class="btn btn-theme"
                           data-animation="flipInY" data-animation-delay="300" target="_blank"> Ampliar Mapa <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
