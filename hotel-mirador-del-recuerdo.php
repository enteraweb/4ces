...
<head>
    ...
    <title> Hotel Mirador del Recuerdo </title>
        ...
        <section id="content" class="content col-sm-8 col-md-9">
            ...
            <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="100">
                <div class="post-media">
                    <img src="assets/img/hoteles/mirador.jpg" alt="Hotel Boutique City Center"/>
                </div>
                <div class="post-header">
                    <h2 class="post-title"><a href="#"> Hotel Mirador del Recuerdo </a></h2>
...
<hr>
                    ...
                    <h2 class="post-title"><a href="#"> Valores agregados </a></h2>
                            ...
                            <ul style="list-style-type:circle">
                              ...
                              <li> Salón de cortesía con 20 pax alojados. </li>
                            </ul>
