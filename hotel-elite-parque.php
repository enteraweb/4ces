...
<head>
    ...
    <title> Hotel Elite del Parque </title>
        ...
        <section id="content" class="content col-sm-8 col-md-9">
            ...
            <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="100">
                <div class="post-media">
                    <img src="assets/img/hoteles/parque.jpg" alt="Hotel Boutique City Center"/>
                </div>
                <div class="post-header">
                    <h2 class="post-title"><a href="#"> Hotel Elite del Parque </a></h2>

                </div>
                <div class="post-body">
                    <div class="post-excerpt">
                    <p><strong>Dirección:</strong> Av. Calle 53 No. 66A 59 / Bogotá - Colombia.<br />
                    <strong>Teléfono:</strong> (571) - 574 53 47.<br />
