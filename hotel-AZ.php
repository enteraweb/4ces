        ...
        <section id="content" class="content col-sm-8 col-md-9">
            ...
            <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="100">
                <div class="post-media">
                    <img src="assets/img/hoteles/AZ.jpg" alt="Hotel Boutique City Center"/>
                </div>
                <div class="post-header">
                    <h2 class="post-title"><a href="#"> Hotel AZ </a></h2>
...
<hr>
                    <h2 class="post-title"><a href="#"> Tarifas </a></h2>
                        <table width="80%" border="0" align="center" cellpadding="3" cellspacing="3">
                          ...
                          <tr>
                            <td>
                            <div align="center"> $130.500 + IVA + SH $4.000 </div>
                            </td>
                            <td><div align="center">
                              <div> $155.700 + IVA + SH $8.000 </div>
                            </div></td>
                            <td><div align="center">
                              <div> $187.200 + IVA + SH $12.000 </div>
                            </div></td>
                          </tr>
                          <tr>
                            <td><div align="center">
                    ...
                    <h2 class="post-title"><a href="#"> Valores agregados </a></h2>
                            ...
                            <ul style="list-style-type:circle">
                              ...
                              <li> Llamadas locales sin costo. </li>
                              <li> Servicio de televisión satelital DIRECTV. </li>
                              <li> Asistencia médica las 24 horas. </li>
                            </ul>
